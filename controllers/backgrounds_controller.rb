class BackgroundsController < ApplicationController
  ...
  # return a background for a given product/feature/background_idurl
  # GET /product_background
  # GET /product_background/:product_idurl/:bgk_idurl/:model_idurl  (i.e. :feature_idurl == root)
  def product_background
    params[:product_idurl]
    params[:bgk_idurl]
    params[:model_idurl]
    params[:feature_idurl] || params[:model_idurl]
  end

  # return a list of backgrounds for a given product/feature
  # GET /product_backgrounds/:product_idurl/:model_idurl/:feature_idurl
  # GET /product_backgrounds/:product_idurl/:model_idurl  (i.e. :feature_idurl == root)
  def product_backgrounds

  end

  # return a background for a given feature/background_idurl
  # GET /knowledge_background/:bgk_idurl/:model_idurl/:feature_idurl
  # GET /knowledge_background/:bgk_idurl/:model_idurl  (i.e. :feature_idurl == root)
  def knowledge_background

  end

  # return a list of backgrounds for a given feature
  # GET /knowledge_backgrounds/:model_idurl/:feature_idurl
  # GET /knowledge_backgrounds/:model_idurl  (i.e. :feature_idurl == root)
